...
window.addEventListener('load', function () {
  ...
  accordions.forEach(function (accordion) {
    var heading = accordion.querySelector('.accordion-header');
  ...
  var splideslider = document.querySelector('#splideslider');
  ...
  var splider = document.querySelector('#splider');
  ...
  var first__tab = document.querySelector('#tab1');
  var second__tab = document.querySelector('#tab2');
  var first__btn = document.querySelector('#firstbtn');
  var second__btn = document.querySelector('#secondbtn');
  if (first__btn) {
